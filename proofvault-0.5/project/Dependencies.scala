...
object Dependencies {
private val tessellationVersion = "2.8.1"
object V {
  ...
  val tessellationShared   = "org.constellation" %% "tessellation-shared"   % tessellationVersion
  val tessellationCurrency = "org.constellation" %% "tessellation-currency" % tessellationVersion
